...
@brief Interface for python logging [and online event tracking (DISABLED)].

DEBUG, INFO, WARNING => console
# ERROR, EXCEPTION     => console + event tracking (rollbar.com)

Use setLevel() to modify console output level.
...
Example:
    ...
    log.setLevel(wwl.WARNING)
    log.warning('space monkeys attacking!')
